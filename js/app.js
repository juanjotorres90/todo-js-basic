...
const createNewTaskElement = (taskString) => { // New Task List Item
...
const addTask = (e) => { // Add a new task
	e.preventDefault();
...
const editTask = function () { // Edit an existing task
	...
	const containsClass = listItem.classList.contains("editMode"); // We check for .editMode and assign it a variable
...
form.addEventListener("submit", addTask); // Adds event listener for the click handler to the addTask function
